    ...
    func sendHangoutInvitation(hangout:Hangout, sender:XMPPJID)
    {
        let block = {
            autoreleasepool {
                ...
                let location = DDXMLElement(name: "locationid", stringValue: "0")
                ...
                hangoutElement.addChild(location)
    ...
    func updateHangout(hangout:Hangout, sender:XMPPJID)
    {
        let block = {
            autoreleasepool {
                ...
                //let locationHangout = hangout.getLocation()
                ...
                let locationid = DDXMLElement(name: "locationid", stringValue: "0")
